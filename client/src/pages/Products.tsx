  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] pt-32 pb-20 px-6 font-sans text-white">
      <div className="max-w-7xl mx-auto">
        ...
        {/* GRID DE PRODUCTOS: MODIFICADO PARA 1 COLUMNA EN MOBILE */}
        {filteredProducts.length > 0 ? (
          <motion.div layout className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
            <AnimatePresence mode="popLayout">
              {filteredProducts.map((product: any, index: number) => (
                ...
                >
                  <div className="p-2 md:p-3 rounded-[3.5rem] bg-white/[0.02] border border-white/5 group-hover:bg-white/[0.04] group-hover:border-pink-500/20 transition-all duration-700">
                    <CardProduct
                      id={product.id}
                      name={product.name}
                      price={product.price}
